...
<b>Table 1. Model accuracy on varying Architecture sizes </b>
...
<figcaption align = "center"><b>Fig 4. Number of CNN layers vs Accuracy</b></figcaption>
</figure>
...
<b> Table 2. Model accuracies against varying dataset sizes </b>
<figure>
<div align="center">
...
<figcaption align = "center"><b>Fig 5. Graph of model accuracy vs dataset size</b></figcaption>
</figure>
...
<figcaption align = "center"><b>Fig 6. A graph displaying the trend of model accuracy
...
<figcaption align = "center"><b>Fig 7. Sample images in the Radiate dataset</b></figcaption>
</figure>
...
<figure>
<div align="left">
<img src="https://git.cs.vt.edu/sdeepti/facial-expression-recognition/-/raw/main/Images/bias_graph.png" width="500" height="300">
</div>
<figcaption align = "center"><b>Fig 8. Bias experiment accuracy comparison</b></figcaption>
</figure>
...
<b>Table 3. Model accuracies against test set with varying values of variance</b>
...
<figcaption align = "center"><b>Fig 9. A graph displaying the trend of model accuracy
...
<figcaption align = "center"><b>Fig 10. Boxplot depicting a statistical significance study
...
<figcaption align="center"><b>Fig 11. Formula for creating adversarial images </b></figcaption>
</figure>
...
<figcaption align="center"><b>Fig 12. Perturbations for images for different epsilon values </b></figcaption>
</figure>
...
<b>Table 4. Model accuracy for varying epsilon values </b>

<figure>
<img src="https://git.cs.vt.edu/sdeepti/facial-expression-recognition/-/raw/main/Images/epsilon_graph.png" width="500" height="400">
<figcaption><b>Fig 13. Model accuracies against varying epsilon values </b></figcaption>
</figure>
...
<figcaption align="center"><b>Fig 14. Model confidenece for image with no perturbation (epsilon = 0) </b></figcaption>
</figure>
...
<figcaption align="center"><b>Fig 15. Model confidence for image with some perturbation (epsilon = 0.01) </b></figcaption>
</figure>
...
<figcaption align="center"><b>Fig 16. Model confidence for image for high level of perturbation (epsilon = 0.3) </b></figcaption>
</figure>
...
<b>Table 5. This table depicts the resulting t-SNE visualization in 2D and 3D space viewing with 20 perplexity value and 100 perplexity value.</b>
...
<figcaption align="center"><b>Fig 17. Saliency map using Vanilla Backpropagation Approach </b></figcaption>
</figure>
...
<b>Table 6. This table depicts the resulting saliency maps using Guided Backprogation. We were able to plot 4 kinds of saliency maps.</b>
...
<figcaption align="center"><b>Fig 18. Sample angry to happy image-to-image transfer results </b></figcaption>
</figure>
